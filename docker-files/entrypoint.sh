...
export USDT_ERC20_MINTING_CONNECTOR_ADDRESS=${USDT_ERC20_MINTING_CONNECTOR_ADDRESS:="0x386331BEF4551b476B2c803B13373193B004289E"}
export USDT_ERC20_LOCKING_CONNECTOR_ADDRESS=${USDT_ERC20_LOCKING_CONNECTOR_ADDRESS:="0x5df28f560AA911B40C316EDad78F9ad378f8aF46"}
...
export WUSDT_TOKEN_ADDRESS=${WUSDT_TOKEN_ADDRESS:="0x81d87E0a53EAf3723Ecc5B57AB11cC04639c9dEa"}
...
find $STATIC_FOLDER -type f -exec sed -i "s,NEXT_PUBLIC_USDT_ERC20_MINTING_CONNECTOR_ADDRESS_STRING_REPLACE,$USDT_ERC20_MINTING_CONNECTOR_ADDRESS,g" {} \;
find $STATIC_FOLDER -type f -exec sed -i "s,NEXT_PUBLIC_USDT_ERC20_LOCKING_CONNECTOR_ADDRESS_STRING_REPLACE,$USDT_ERC20_LOCKING_CONNECTOR_ADDRESS,g" {} \;
...
find $STATIC_FOLDER -type f -exec sed -i "s,NEXT_PUBLIC_WUSDT_TOKEN_ADDRESS_STRING_REPLACE,$WUSDT_TOKEN_ADDRESS,g" {} \;
