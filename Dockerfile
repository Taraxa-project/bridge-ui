...
ARG NEXT_PUBLIC_USDT_ERC20_MINTING_CONNECTOR_ADDRESS=NEXT_PUBLIC_USDT_ERC20_MINTING_CONNECTOR_ADDRESS_STRING_REPLACE
ARG NEXT_PUBLIC_USDT_ERC20_LOCKING_CONNECTOR_ADDRESS=NEXT_PUBLIC_USDT_ERC20_LOCKING_CONNECTOR_ADDRESS_STRING_REPLACE
...
ARG NEXT_PUBLIC_WUSDT_TOKEN_ADDRESS=NEXT_PUBLIC_WUSDT_TOKEN_ADDRESS_STRING_REPLACE
